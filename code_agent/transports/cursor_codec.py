...
MESSAGES = {
    ...
    "ConversationAction": [
        ...
        F("triggeringUserInfo", 15, type="bytes"),
        F("subscriptionNotificationAction", 16, type="M:SubscriptionNotificationAction"),
        F("requestContextParts", 17, type="bytes", rep=True),
    ...
    "CancelAction": [
        ...
        F("interruptedPendingToolCallResolutions", 3, type="bytes"),
    ],
    "SummarizeAction": [],
    "ShellCommandAction": [
    ...
    "AsyncAskQuestionCompletionAction": [
        ...
        F("originalArgs", 2, type="string"),
        F("result", 3, type="string"),
    ],
    "CancelSubagentAction": [
        F("subagentId", 1, type="string"),
    ],
    "BackgroundTaskCompletionAction": [
        F("completions", 1, type="bytes", rep=True),
    ],
    ...
    "InjectContextAction": [
        ...
        F("userContext", 3, type="bytes"),
        F("systemContext", 4, type="bytes"),
    ],
    "UserMessageAction": [
        F("userMessage", 1, type="M:UserMessage"),
        F("requestContext", 2, type="M:RequestContext"),
        ...
        F("interruptedPendingToolCallResolutions", 6, type="bytes"),
        F("conversationHistory", 7, type="bytes"),
    ],
    "UserMessage": [
        F("text", 1, type="string"),
